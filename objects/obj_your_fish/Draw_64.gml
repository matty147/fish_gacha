if display_text
{
	...
	draw_text_ext_transformed_color(x + sprite_width / 2,y + sprite_height * 3/4 + 10,string(amount - global.fish_cought[numb_in_fish_table][2]) + "x",0,500,1,1,0,c_white,c_white,c_white,c_white,1);	
}