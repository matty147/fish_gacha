...
draw_text_ext_transformed_color(x + sprite_get_width(asset_get_index("spr_" + string(display_fish))),y + 10,display_fish,0,300,1,1,0,c_white,c_white,c_white,c_white,1);
